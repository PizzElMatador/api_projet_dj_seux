...
{
    public class Prestataire : BDDObject
    {
        private string nom;
        ...
        public string Date_inscription { get => date_inscription; set => date_inscription = value; }
        public int Id_utilisateur { get => id_utilisateur; set => id_utilisateur = value; }

        public Prestataire() { }

        public Prestataire(string nom, string prenom, string email, string mot_de_passe, string date_inscription, int id_utilisateur) : base()
        {
            this.Nom = nom;
            this.Prenom = prenom;
            this.Email = email;
        ...
        public override string GetTableName() => "Prestataire";
        ...
        public override List<IDataParameter> GetInsertUpdateParameters()
        {
            return new List<IDataParameter>
            {
                ...
                new MySqlParameter("@date_inscription", MySqlDbType.VarChar) { Value = this.Date_inscription },
        ...
        public override void FillWithDataReader(DbDataReader reader)
        {
            ...
            this.Date_inscription = reader["date_inscription"].ToString();
            this.Id_utilisateur = System.Convert.ToInt32(reader["id_utilisateur"]);
        }
        ...
        public override IBDDConnector getNewInstance() => new Prestataire();
    }
}